...
function Task_modal(props) {
  const [taskNameValue, setTaskNameValue] = useState(
    props.modalDiscription_.taskName,
  );
  const [taskMemoValue, setTaskMemoValue] = useState(
    props.modalDiscription_.taskMemo,
  );
          ...
          <View style={styles.button_View}>
            {props.modalType_ === 'update' ? (
              <TouchableOpacity
                ...
                underlayColor="#fff"
                onPress={async () => {
                  let kojikoji = await connectTable(
                    'delete',
                    props.modalDiscription_.id,
                    taskNameValue,
                    doWbuttonColor,
                    taskMemoValue,
                  );
                  props.changeTable_();
                  props.setReadCompleateFlag_(false);
